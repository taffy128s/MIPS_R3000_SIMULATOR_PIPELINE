...
extern unsigned IF_HALT, ID_HALT, EX_HALT, DM_HALT, WB_HALT, FWD_RS_TO_EX, FWD_RT_TO_EX, FWD_RS_TO_ID, FWD_RT_TO_ID, STALL, FLUSH;
...
unsigned IF_HALT, ID_HALT, EX_HALT, DM_HALT, WB_HALT, FWD_RS_TO_EX, FWD_RT_TO_EX, FWD_RS_TO_ID, FWD_RT_TO_ID, STALL, FLUSH;
